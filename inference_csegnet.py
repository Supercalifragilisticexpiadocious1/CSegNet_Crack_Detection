...
from utils import load_csegnet
...
if __name__ == '__main__':
    ...
    parser.add_argument('-out_dir', type=str, default='./test_result', help='threshold to cut off crack response')
    ...
    if args.model_type == 'csegnet':
        model = load_csegnet(args.model_path)
