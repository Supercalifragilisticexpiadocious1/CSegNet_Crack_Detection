...
def create_model(device, type='csegnet'):
    if type == 'csegnet':
        print("create CSegNet model")
        model = CSegNet()
    else:
        assert False
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CSegNet Training')
    ...
    parser.add_argument('-data_dir', type=str, default='./datasets/train', help='input dataset directory')
    parser.add_argument('-model_dir', type=str, default='./models', help='output dataset directory')
    parser.add_argument('-model_type', type=str, required=False, default='csegnet', choices=['csegnet'])
